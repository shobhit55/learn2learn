...
def main(
    ...
    for iteration in range(num_iterations):
        ...
        adapt_reward_vec.append(adaptation_reward)
        ...
        if iteration%10==0:
            # fig, ax = plt.figure()
            plt.plot(np.linspace(0,len(adapt_reward_vec)-1, len(adapt_reward_vec)), adapt_reward_vec)
            plt.savefig('../tests/maml_trpo_2dpoint.png')
            np.save('../tests/maml_trpo_2dpoint_adapt_rewards_vec', np.array(adapt_reward_vec))
